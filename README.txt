...
__This is a custom plugin and will not work on all WP installs as it requires several customisations, creation of several custom post types and some additional plugins (Scrabble Tou CPT and Pods - Custom Content Types and Fields https://pods.io/) to work__. Scrabble Tou CPT is a custom plugin.
